    ...
    <div className="flex justify-center bg-slate-50 py-24 px-5 xl:px-0" id="experience">
        <div className="w-[75rem]">
            <div className="flex flex-col justify-center items-center text-center">
                ...
                <p className="w-full sm:w-[35rem] leading-loose text-slate-500 text-lg">Lorem, ipsum dolor sit amet consectetur adipisicing elit odio Molestiae itaque ab asperiores, natus nostrum sunt rem mollitia architecto explica</p>
